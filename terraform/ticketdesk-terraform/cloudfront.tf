...
resource "aws_cloudfront_distribution" "cdn" {
  ...
  # Default Cache Behavior -> Route static assets to S3
  ...
  # Dynamic API Cache Behavior -> Route /api/* requests to ALB
...
# Policy allowing CloudFront OAC to read from S3 Frontend Bucket
